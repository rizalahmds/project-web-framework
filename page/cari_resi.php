...
if(isset($_POST['cari'])){
  ...
  $totalcari = mysqli_num_rows($tampil); ?>
 <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Delivery Veiw</h1>
                  <small>Delivery View List</small>
               </div>
            </section>
            <!-- Main content -->
            <section class="content">
               <div class="row">
                  ...
                  <div class="btn-group" id="buttonexport" style="width: 100%;">
                     ...
                     <center>
                     <a href="#">
                        <h2>DELIVERY KURIR TRANSAKSI VIEW</h2>
                     </a>
                  </center>
                  </div>
                  </div>
                        ...
                        <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                         ...
                         <div class="table-responsive">
                              <table class="table table-bordered table-hover">
                                 ...
                                 <?php
                                       include "configs.php"; 
                                       $query11 ="SELECT * FROM delivery,transaksi,propinsi,kabupaten WHERE delivery.resi_no=transaksi.no_resi AND transaksi.provinsi=propinsi.id_propinsi AND transaksi.kota_kab=kabupaten.id_kabupaten AND  delivery.kurir='$_SESSION[namapenjual]' ";
                                       $no=1;
